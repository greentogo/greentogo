...
def user_report(request,*args, **kwargs):
    ...
    activeSubs = Subscription.objects.all().active()
    payingSubs = activeSubs.is_paying()
    view_data = {
        "data": payingSubs,
        "numberOfUsers":allUsers,
        "numberOfActiveSubs":len(activeSubs),
        "numberOfPayingSubs":len(payingSubs),
    }
    print(view_data)
