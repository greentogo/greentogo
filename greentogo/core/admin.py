...
class LocationAdmin(admin.ModelAdmin):
    fields = ('name', 'code', 'service', 'address', 'website', 'latitude', 'longitude', 'minimum_boxes', 'phase', 'admin_location', 'headquarters', 'washing_location', 'dumping_location', 'notify', 'notifyEmail', 'retired', 'error_rate', 'avg_weekly_usage_over_past_4_weeks', 'neighborhood', 'dashboard', 'preferred_delivery_time', 'has_boxes', 'has_cups', )
    readonly_fields = ('code', 'latitude', 'longitude', 'is_admin_location', 'error_rate', 'avg_weekly_usage_over_past_4_weeks', 'dashboard', )
    list_display = ('name', 'avg_weekly_usage_over_past_4_weeks', 'code', 'service', 'is_admin_location', )
    actions = [
        'make_qrcodes',
    ]
